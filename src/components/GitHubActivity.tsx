        ...
        <div className="w-full glass-card rounded-[2rem] border-zinc-800/50 p-4 sm:p-6 lg:p-8">
          <div className="flex flex-col gap-6 2xl:flex-row 2xl:items-stretch">
            <a
              ...
              className="min-w-0 flex-1 overflow-hidden rounded-2xl border border-zinc-800/70 bg-zinc-950/35 p-5 sm:p-7 lg:p-8 transition-colors hover:bg-zinc-950/50 group/card"
            >
              <div className="mb-6 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-medium text-zinc-100 group-hover/card:text-blue-400 transition-colors">
                      Contribution Calendar
                    </h3>
                  </div>
                </div>
                <ExternalLink className="h-4 w-4 shrink-0 text-zinc-600 group-hover/card:text-zinc-400 transition-colors" />
              </div>

              <div className="github-activity-scroll w-full">
                <GitHubCalendar
                  username="maneeq166"
                  colorScheme="dark"
                  blockSize={isMobile ? 16 : 14}
                  blockMargin={isMobile ? 5 : 4}
                  fontSize={isMobile ? 13 : 12}
                  className="github-activity-calendar w-full text-zinc-400"
                />
              </div>
            </a>
